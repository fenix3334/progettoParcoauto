...
def show_system_info():
    ...
    # Info database
    if os.path.exists('fleet_manager.db'):
        db_size = os.path.getsize('fleet_manager.db') / 1024
        print(f"💾 Database: fleet_manager.db ({db_size:.1f} KB)")
